...
http_archive(
    name = "rules_rust",
    strip_prefix = "rules_rust-d1fc9accc588e73c5b613119e0051ea7bc32d6c0",
    urls = [
        # Master branch as of 2021-06-29
        "https://github.com/bazelbuild/rules_rust/archive/d1fc9accc588e73c5b613119e0051ea7bc32d6c0.tar.gz",
    ],
)
